function getInputValue(){
    ...
    if(inputVal==1){
        document.getElementById("demo").innerHTML ="Akash Bhilwande";
    ...
    {
        document.getElementById("demo").innerHTML ="Akash Mane";
        document.getElementById("demo1").innerHTML ="10000";   
    }

    else if(inputVal==4)
    {
        document.getElementById("demo").innerHTML ="JAY  BHANUSHALI";
        document.getElementById("demo1").innerHTML ="10000";   
    }
    else if(inputVal==5)
    {
        document.getElementById("demo").innerHTML ="SMITKUMAR  BHEDA";
        document.getElementById("demo1").innerHTML ="10000";   
    }
    else if(inputVal==6)
    {
        document.getElementById("demo").innerHTML ="VIKAS  CHAUDHARY";
